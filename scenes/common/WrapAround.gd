#Code that Wraps entites around the borders of the screen.
#Taken from sp33dy's Godot-v3-Tutorials, https://github.com/sp33dy/Godot-v3-Tutorials-Competent
...
# Recalculate the wrap area again. Called when window size has changed.
